...
<center>  <h2><div class="page-content">Available Advert Report </div></center></h2></center>
...
$sql = "SELECT name, des, price, image, type, Horse_power, Petrol_Desel, Manufactured_year,
Used_Brandnew, Milage, Engine_capacity, Manual_auto,image,image2,image3,image4,seller_name,email,tel,extra_info,id FROM vehicles";
